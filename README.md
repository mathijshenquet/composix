...
- [The tour](docs/tour/index.md) — executable documentation: every transcript is generated by
  ...
  fail.
- [The migration corpus](docs/corpus/index.html) — every checked-in Docker/Kubernetes artifact
  beside its Cixfile or Nix conversion, with the ledger ribbon and empirical receipt attached.
...
- [cips/](cips/) — Composix Improvement Proposals: adopted design rounds
