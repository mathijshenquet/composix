...
let
  ...
  downgradedCorpus = [ "docker/directus" "docker/dozzle" "docker/echo-server" "docker/excalidraw" "docker/filebrowser" "docker/filestash" "docker/haproxy" "docker/homer" "docker/httpd" "docker/it-tools" "docker/mailpit" "docker/mosquitto" "docker/ntfy" "docker/parse-server" "docker/postgres" "docker/registry" "docker/valkey" "docker/verdaccio" "docker/wallos" "docker/watchtower" "docker/whoami" ];
