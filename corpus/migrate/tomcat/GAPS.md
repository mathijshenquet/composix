...
- Whole packages are copied to ad-hoc `/coreutils`, `/gnused`, `/tomcat`, and `/jre` roots and stitched together with a hand-built `PATH`. → language ([artifact-import draft](../../../cips/draft/artifact-import.md))
