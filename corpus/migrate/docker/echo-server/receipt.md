...
After `bash corpus/migrate/docker/fetch.sh echo-server` exited 0, both
`target/debug/cix build corpus/migrate/docker/echo-server` and the build performed by
