...
After `bash corpus/migrate/docker/fetch.sh parse-server` exited 0, the assembler's first
`target/debug/cix build corpus/migrate/docker/parse-server` exited 1 because fetched
