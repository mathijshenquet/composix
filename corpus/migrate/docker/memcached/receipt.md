...
bash corpus/migrate/docker/fetch.sh memcached
./target/debug/cix build corpus/migrate/docker/memcached
./target/debug/cix build --file Cixfile.dissolved corpus/migrate/docker/memcached
cd corpus/migrate/docker/memcached && CIX=/home/mathijs/worktrees/composix/track-regen1/target/debug/cix ./check.sh cix
```
