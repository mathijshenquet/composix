...
- Faithful cold replay exits 1 after build output generation because the recorded warm read at `output/usr/local/apache2/conf/extra/sedAsylf1` is `Some(Absent)` while cold records `None`. → language (CIP-87)
