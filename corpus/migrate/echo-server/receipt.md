...
Cix refresh: 2026-07-31. Language generation: D56–D64 (`IMPORT`, builder `ENV`, bare builder commands, explicit Node `bin/`, `GRANT jit`, and D58's `/usr/bin/env` skeleton alias).
