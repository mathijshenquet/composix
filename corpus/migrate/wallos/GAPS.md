...
- Six package binaries are linked individually into `/bin`, the corpus's clearest artifact toolset pile. → language ([artifact-import draft](../../../cips/draft/artifact-import.md))
