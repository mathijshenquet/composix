...
bash corpus/migrate/fetch.sh nginx
./target/debug/cix build corpus/migrate/nginx
./target/debug/cix build --file Cixfile.dissolved corpus/migrate/nginx
cd corpus/migrate/nginx && CIX=/home/mathijs/worktrees/composix/track-regen1/target/debug/cix ./check.sh cix
```
