...
BUILDER build memo miss fc2b71f4c51c -> /nix/store/…-cix-build-view
```
...
$ CIX_BUILD_WORKSPACE_DIR=$PWD/../.workspaces-run cix build .
{"run-tour":"/nix/store/…-cix-item-run-tour"}
BUILDER build memo hit fc2b71f4c51c -> /nix/store/…-cix-build-view
```
...
BUILDER build step 2 RUN executed
BUILDER build memo miss 68686cfbeac1 -> /nix/store/…-cix-build-view
```
...
$ CIX_BUILD_WORKSPACE_DIR=$PWD/../.workspaces-run cix build .
{"run-tour":"/nix/store/…-cix-item-run-tour"}
BUILDER build memo hit 68686cfbeac1 -> /nix/store/…-cix-build-view
```
