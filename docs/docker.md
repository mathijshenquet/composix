...
| [bridge networks and service DNS](https://docs.docker.com/engine/network/drivers/bridge/) | 🔶 `network: "pod"` creates one named netns with shared localhost; an egress-claiming pod gets one networkd-managed veth into cix's fixed bridge and a persisted address. | D26 user-defined/named networks, embedded DNS, aliases, cross-composite attachment, and general IPAM objects remain era-parked. |
