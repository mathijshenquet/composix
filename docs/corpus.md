...
| 7 | [Immich](https://raw.githubusercontent.com/immich-app/immich/main/docker/docker-compose.yml) | env-interpolated bind paths, image healthchecks, shm_size, GPU overlays | binds ⏳ compose operator-binds; shm ✅ easier; GPU 🔶 devices | M | desk |
...
| 17 | [Frigate](https://docs.frigate.video/frigate/installation) | privileged, 5 device passthroughs, sized tmpfs, shm | devices 🔶 `DeviceAllow=` sans privileged; tmpfs/shm ✅ easier; hardening story fights the default | L | desk |
