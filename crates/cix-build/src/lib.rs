...
/// One compatibility boundary for the stage-2 execution semantics and CIP-110
/// canonical-AST/NAR identity changes; old memo entries must not cross it.
pub const BUILDER_FINGERPRINT: &str = concat!(
    env!("CARGO_PKG_VERSION"),
    ":epoch-v1-stage2-canonical-ast-nar"
);
pub use model::{
